  ...
  public static class Builder {
    ...
    public PasswordGenerator build() throws IllegalStateException {
      if (upperCaseRequired && !upperCaseAllowed) {
        throw new IllegalStateException("Upper-case cannot be both not allowed and required.");
      } else if (lowerCaseRequired && !lowerCaseAllowed) {
        throw new IllegalStateException("Lower-case cannot be both not allowed and required.");
      } else if (digitsRequired && !digitsAllowed) {
        throw new IllegalStateException("Digits cannot be both not allowed and required.");
      } else if (punctuationRequired && !punctuationAllowed) {
        throw new IllegalStateException("Punctuation cannot be both not allowed and required.");
      }
